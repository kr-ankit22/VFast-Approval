        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><Link href="/#facilities"><a className="hover:text-white">Facilities</a></Link></li>
              <li><Link href="/#about"><a className="hover:text-white">How to Book</a></Link></li>
          ...
          <div>
            <h3 className="text-lg font-semibold font-poppins mb-4">Connect With Us</h3>
            ...
            <p className="text-gray-300 text-sm">
              Email: vfast@bits-pilani.ac.in<br />
              Phone: +91-1596-255XXX
            </p>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} VFast Hostel, BITS Pilani. All rights reserved.
        </div>
      </div>
    </footer>
  );
